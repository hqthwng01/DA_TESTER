...
namespace StoreManager.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            var storeManagerContext = _context.Products.Include(p => p.ProductType);
        ...
        public async Task<IActionResult> ByPriceRange()
        {
            var product = from pro in _context.Products
                           where pro.Price >= 40000 && pro.Price <= 60000
                           select pro;
        ...
        public IActionResult Search(string SearchString = "")
        {
            ...
            if (SearchString != "" && SearchString != null)
            {
                ...
                .Where(p => p.Name.Contains(SearchString) || p.SKU.Contains(SearchString))
                .ToList();
            }
            else
